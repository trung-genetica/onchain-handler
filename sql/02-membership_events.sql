CREATE TABLE membership_events (
    ...
    CONSTRAINT membership_events_transaction_hash_unique UNIQUE (transaction_hash)
);

CREATE INDEX membership_events_order_id_idx ON membership_events (order_id);
CREATE INDEX membership_events_status_end_duration_idx ON membership_events (status, end_duration);
